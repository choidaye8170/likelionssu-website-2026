...
const PROJECTS_RAW = [
  ...
  },
  {
    ...
    about:
      " Remini는 회고를 더욱 압축적이고 효율적으로 진행할 수 있도록 돕는 맞춤 회고 유형 추천 서비스입니다. 사용자의 회고 상황에 따라 적절한 회고 방식을 추천하고, 효과적인 회고 진행을 위한 가이드라인을 제공합니다. 회고는 기간과 진행 여부에 따라 최적의 회고 유형을 안내합니다. KPT, 5F, TIL, 4L 등 다양한 회고 프레임워크를 제공하며, 이를 통해 개인과 팀이 효과적으로 회고를 수행하고 지속적인 성장을 이룰 수 있도록 지원합니다.",
    stack: [
      "TypeScript",
      "React",
      "Styled-Components",

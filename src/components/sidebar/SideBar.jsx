...
export default function SideBar({ isOpen, onClose }) {
  ...
  return (
    <>
      {/* Overlay */}
      <div
        className={`fixed inset-0 z-250 transition-opacity duration-300 ${isOpen ? "opacity-100 visible" : "opacity-0 invisible"}`}
      ...
      <div
        className={`fixed top-0 right-0 w-[18.625rem] bg-secondarybrand z-300 transform transition-transform duration-300
